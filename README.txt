...
1.0, such that you'll have less stamina drain. If you want to have less stamina, set this value to something
greater than 1.0. If you set the multiplier to 0.0, you'll have infinite stamina.

After changing the value inside the "multiplier.txt" file, you need to place "ndarc.exe" in the same directory
